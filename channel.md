...
- Last automated source refresh: **2026-09-09T03:31:04.383428+00:00**
...
- Replacement search: **7** failed URLs; candidates found **8**; URLs refreshed **2**
- Register rows checked: **94**; withheld rows reviewed: **2**; identity-review candidates: **0**; withheld probe failures: **1**
- Safe failures retained without replacement: no replacement **5**, replacement probe failures **0**, unavailable catalogs **0**, source not active **0**
