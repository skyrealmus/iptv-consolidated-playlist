...
- Last automated source refresh: **2026-08-18T01:19:06.259418+00:00**
...
- Replacement search: **12** failed URLs; candidates found **31**; URLs refreshed **1**
- Register rows checked: **94**; withheld rows reviewed: **2**; identity-review candidates: **0**; withheld probe failures: **1**
- Safe failures retained without replacement: no replacement **5**, replacement probe failures **6**, unavailable catalogs **0**, source not active **0**
