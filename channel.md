...
- Last automated source refresh: **2026-07-30T14:10:18.817854+00:00**
- Playlist URLs checked: **94**; accessible: **71**; inaccessible: **23**
- Content failures: black **0**, blank/uniform **0**, stale/unchanging **17**, no decoded video **6**
- Replacement search: **23** failed URLs; candidates found **47**; URLs refreshed **13**
- Register rows checked: **95**; withheld rows reviewed: **1**; identity-review candidates: **1**; withheld probe failures: **0**
- Safe failures retained without replacement: no replacement **5**, replacement probe failures **5**, unavailable catalogs **0**, source not active **0**
...
| # | Requested | Display | Status |
|---:|---|---|---|
| 1 | `CCTV-1 综合` | `CCTV-1 综合` | IMPORTED |
| 2 | `CCTV-2 财经` | `CCTV-2 财经` | IMPORTED |
| 3 | `CCTV-3 综艺` | `CCTV-3 综艺` | IMPORTED |
| 4 | `CCTV-4 中文国际` | `CCTV-4 中文国际` | IMPORTED |
| 5 | `CCTV-5 体育` | `CCTV-5 体育` | IMPORTED |
| 6 | `CCTV-5+ 体育赛事` | `CCTV-5+ 体育赛事` | IMPORTED |
| 7 | `CCTV-6 电影` | `CCTV-6 电影` | IMPORTED |
| 8 | `CCTV-7 国防军事` | `CCTV-7 国防军事` | IMPORTED |
| 9 | `CCTV-8 电视剧` | `CCTV-8 电视剧` | IMPORTED |
| 10 | `CCTV-9 纪录` | `CCTV-9 纪录` | IMPORTED |
| 11 | `CCTV-10 科教` | `CCTV-10 科教` | IMPORTED |
| 12 | `CCTV-11 戏曲` | `CCTV-11 戏曲` | IMPORTED |
| 13 | `CCTV-12 社会与法` | `CCTV-12 社会与法` | IMPORTED |
| 14 | `CCTV-13 新闻` | `CCTV-13 新闻` | IMPORTED |
| 15 | `CCTV-14 少儿` | `CCTV-14 少儿` | IMPORTED |
| 16 | `CCTV-15 音乐` | `CCTV-15 音乐` | IMPORTED |
| 17 | `CCTV-16 奥林匹克` | `CCTV-16 奥林匹克` | IMPORTED |
| 18 | `CCTV-17 农业农村` | `CCTV-17 农业农村` | IMPORTED |
| 19 | `CCTV 世界地理` | `CCTV 世界地理` | IMPORTED |
| 20 | `CCTV 兵器科技` | `CCTV 兵器科技` | IMPORTED |
| 21 | `CCTV 风云足球` | `CCTV 风云足球` | IMPORTED |
| 22 | `CCTV 高尔夫网球` | `CCTV 高尔夫网球` | IMPORTED |
| 23 | `CCTV 4k 超高清` | `CCTV 4k 超高清` | IMPORTED |
| 24 | `CCTV 8k超高清` | `CCTV 8k超高清` | IMPORTED |
| 25 | `东方卫视` | `东方卫视` | IMPORTED |
| 26 | `湖南卫视` | `湖南卫视` | IMPORTED |
| 27 | `TVBS亚洲` | `TVBS亚洲` | IMPORTED |
| 28 | `TVBS新闻` | `TVBS新闻` | IMPORTED |
| 29 | `凤凰资讯` | `凤凰资讯` | IMPORTED |
| 30 | `东森超视` | `东森超视` | IMPORTED |
| 31 | `Channel 8` | `Channel 8` | IMPORTED |
