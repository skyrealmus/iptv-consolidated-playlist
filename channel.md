...
- Last automated source refresh: **2026-08-11T01:49:32.053891+00:00**
- Playlist URLs checked: **94**; accessible: **73**; inaccessible: **21**
- Content failures: black **0**, blank/uniform **0**, stale/unchanging **10**, no decoded video **10**
- Replacement search: **21** failed URLs; candidates found **52**; URLs refreshed **6**
- Register rows checked: **95**; withheld rows reviewed: **1**; identity-review candidates: **0**; withheld probe failures: **1**
- Safe failures retained without replacement: no replacement **5**, replacement probe failures **10**, unavailable catalogs **0**, source not active **0**
...
|---:|---|---|---|
| 1 | `CCTV-1 综合` | `CCTV-1 综合` | PUBLISHED |
| 2 | `CCTV-2 财经` | `CCTV-2 财经` | PUBLISHED |
| 3 | `CCTV-3 综艺` | `CCTV-3 综艺` | PUBLISHED |
| 4 | `CCTV-4 中文国际` | `CCTV-4 中文国际` | PUBLISHED |
| 5 | `CCTV-5 体育` | `CCTV-5 体育` | PUBLISHED |
| 6 | `CCTV-5+ 体育赛事` | `CCTV-5+ 体育赛事` | PUBLISHED |
| 7 | `CCTV-6 电影` | `CCTV-6 电影` | PUBLISHED |
| 8 | `CCTV-7 国防军事` | `CCTV-7 国防军事` | PUBLISHED |
| 9 | `CCTV-8 电视剧` | `CCTV-8 电视剧` | PUBLISHED |
| 10 | `CCTV-9 纪录` | `CCTV-9 纪录` | PUBLISHED |
| 11 | `CCTV-10 科教` | `CCTV-10 科教` | PUBLISHED |
| 12 | `CCTV-11 戏曲` | `CCTV-11 戏曲` | PUBLISHED |
| 13 | `CCTV-12 社会与法` | `CCTV-12 社会与法` | PUBLISHED |
| 14 | `CCTV-13 新闻` | `CCTV-13 新闻` | PUBLISHED |
| 15 | `CCTV-14 少儿` | `CCTV-14 少儿` | PUBLISHED |
| 16 | `CCTV-15 音乐` | `CCTV-15 音乐` | PUBLISHED |
| 17 | `CCTV-16 奥林匹克` | `CCTV-16 奥林匹克` | PUBLISHED |
| 18 | `CCTV-17 农业农村` | `CCTV-17 农业农村` | PUBLISHED |
| 19 | `CCTV 世界地理` | `CCTV 世界地理` | PUBLISHED |
